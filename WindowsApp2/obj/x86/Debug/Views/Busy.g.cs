#pragma checksum "F:\TournamentApp\WindowsApp2\Views\Busy.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "75DCA5B78A0FFDB6D35DADDABF69903A"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace WindowsApp2.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class Busy_obj1_Bindings :
            ...
            IBusy_Bindings
        {
            private global::WindowsApp2.Views.Busy dataRoot;
            ...
            public void SetDataRoot(global::WindowsApp2.Views.Busy newDataRoot)
            {
                this.bindingsTracking.ReleaseAllListeners();
            ...
            private void Update_(global::WindowsApp2.Views.Busy obj, int phase)
            {
            ...
            private void UpdateFallback_BusyText(int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    XamlBindingSetters.Set_Windows_UI_Xaml_Controls_TextBlock_Text(this.obj3, "Co� posz�o nie tak", null);
                }
            }
            ...
            private class Busy_obj1_BindingsTracking
            {
                ...
                public void DependencyPropertyChanged_IsBusy(global::Windows.UI.Xaml.DependencyObject sender, global::Windows.UI.Xaml.DependencyProperty prop)
                {
                    ...
                    {
                        global::WindowsApp2.Views.Busy obj = sender as global::WindowsApp2.Views.Busy;
        if (obj != null)
        {
        ...
        bindings.UpdateFallback_BusyText(DATA_CHANGED);
                ...
                public void UpdateChildListeners_(global::WindowsApp2.Views.Busy obj)
                {
                    Busy_obj1_Bindings bindings;
                    if(WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        {
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::WindowsApp2.Views.Busy.IsBusyProperty, tokenDPC_IsBusy);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::WindowsApp2.Views.Busy.BusyTextProperty, tokenDPC_BusyText);
                        }
                        if (obj != null)
                        {
                            bindings.dataRoot = obj;
                            tokenDPC_IsBusy = obj.RegisterPropertyChangedCallback(global::WindowsApp2.Views.Busy.IsBusyProperty, DependencyPropertyChanged_IsBusy);
                            tokenDPC_BusyText = obj.RegisterPropertyChangedCallback(global::WindowsApp2.Views.Busy.BusyTextProperty, DependencyPropertyChanged_BusyText);
                        }
                    }
                }
            }
