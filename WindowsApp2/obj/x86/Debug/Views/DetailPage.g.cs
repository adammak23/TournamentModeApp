#pragma checksum "F:\TournamentApp\WindowsApp2\Views\DetailPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "3B09C61333C6BF85A01D1876F9850CC1"
//------------------------------------------------------------------------------
// <auto-generated>
            ...
            IDetailPage_Bindings
        {
            ...
            private void Update_ViewModel(global::WindowsApp2.ViewModels.DetailPageViewModel obj, int phase)
            {
                ...
                if (obj != null)
                {
                    ...
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_ViewModel_SummonerIconImageString(obj.SummonerIconImageString, phase);
                    }
                }
            }
            ...
            private void Update_ViewModel_SummonerIconImageString(global::System.String obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
