#pragma checksum "F:\WindowsApp2\WindowsApp2\Views\DetailPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "2CA9AD35FF2581D3FF259FB20DECC9B6"
//------------------------------------------------------------------------------
// <auto-generated>
            ...
            IDetailPage_Bindings
        {
            ...
            private void Update_ViewModel(global::WindowsApp2.ViewModels.DetailPageViewModel obj, int phase)
            {
                ...
                else
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.UpdateFallback_ViewModel_Login(phase);
                    }
                }
            }
            ...
            private void UpdateFallback_ViewModel_Login(int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                ...
                public void PropertyChanged_ViewModel(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
                {
                    ...
                    if(WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            ...
                            {
                                bindings.UpdateFallback_ViewModel_Login(DATA_CHANGED);
                            }
                        }
                        else
                        {
